        ...
        <div class="grid grid-cols-1 gap-2 md:grid-cols-4 md:gap-4">
            <div class="flex justify-center md:justify-start">
                <a href="" target="_blank" class="m-3">
                    <img src="{{ asset('images/icons/facebook.png') }}" alt="Facebook" class="w-6 h-6" />
                </a>
                <a href="" target="_blank" class="m-3">
                    <img src="{{ asset('images/icons/youtube.png') }}" alt="Youtube" class="w-6 h-6" />
                </a>
                <a href="" target="_blank" class="m-3">
                    <img src="{{ asset('images/icons/instagram.png') }}" alt="Instagram" class="w-6 h-6" />
                </a>
                <a href="" target="_blank" class="m-3">
                    <img src="{{ asset('images/icons/twitter.png') }}" alt="Twitter" class="w-6 h-6" />
                </a>
            </div>
            <div class="">
                <h3 class="text-white text-2xl mb-3 md:mb-5 border-l-8 border-blue-800 pl-5">Contato</h3>
                <p class="flex text-gray-400 mb-3">
                    <img src="{{ asset('images/icons/address.png') }}" alt="endereço" class="w-5 h-5 mr-3" /> Rua
                    Piaçabuçu, 8-b, Canaã, 570080-030, Maceió/AL
                </p>
            ...
            <div class="">
                ...
                <a href="" class="text-gray-400 block hover:text-white">Área do franqueado</a>
                <a href="" class="text-gray-400 block hover:text-white">Nova conta</a>
            </div>
            <div class="">
