                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="confirmation" class="form-control">
                                                                <option value="N" @if ($lead->financy->confirmation == "N") selected @endif>
                                                                    Em analise, aguardando confirmação.</option>
                                                                <option value="S" @if ($lead->financy->confirmation == "S") selected @endif>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="text" name="value_client" id="value_client"
                                                            onkeyup="moeda(this);"
                                                            value="{{ number_format($lead->financy->value_client, 2, ',', '.') }}"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="text" name="fees" id="fees"
                                                            onkeyup="moeda(this);"
                                                            value="{{ number_format($lead->financy->fees, 2, ',', '.') }}"
