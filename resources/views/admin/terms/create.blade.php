                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                            ...
                            <input type="date" name="audiencia" value="{{ old('audiencia') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group m-0">
                            ...
                            <input type="text" name="address" value="{{ old('address') }}" class="form-control" maxlength="250" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group m-0">
