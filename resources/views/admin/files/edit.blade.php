...
@section('content_header')
    <div style="display: flex; justify-content: space-between">
        ...
        <a href="{{ route('admin.files.index') }}" class="btn btn-md bg-info">Listar Registros</a>
    </div>
@stop

@section('content')

    <form method="POST" action="{{ route('admin.files.update', ['id' => $file->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card card-info" style="max-width: 800px; margin: auto">
            ...
            <div class="card-footer">
                <a href="{{ route('admin.files.index') }}" type="submit" class="btn btn-default">Cancelar</a>
